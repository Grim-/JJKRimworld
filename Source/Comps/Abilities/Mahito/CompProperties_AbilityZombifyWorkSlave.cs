    ...
    public class CompAbilityEffect_ZombifyWorkSlave : CompAbilityEffect
    {
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            if (targetPawn != null)
            {
                ...
                Hediff zombieHediff = HediffMaker.MakeHediff(JJKDefOf.JJK_ZombieWorkSlaveHediff, targetPawn);
                targetPawn.health.AddHediff(zombieHediff);


                Hediff addedHeDiff = targetPawn.health.hediffSet.GetFirstHediffOfDef(JJKDefOf.JJK_ZombieWorkSlaveHediff);
