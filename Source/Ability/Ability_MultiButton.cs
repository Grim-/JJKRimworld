...
namespace JJK
{
    public class Ability_MultiButton : Ability
    {
        public Ability_MultiButton(Pawn pawn) : base(pawn)
        {
        }

        public Ability_MultiButton(Pawn pawn, AbilityDef def) : base(pawn, def)
        {
        }
